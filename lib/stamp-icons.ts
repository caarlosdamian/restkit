...
export const STAMP_ICONS: StampIcon[] = [
  ...
  { id: 'tennis', label: 'Tenis', category: 'deportes', keywords: ['tenis', 'pelota', 'pádel', 'squash', 'cancha'],
    d: 'M12 2a10 10 0 1 0 0 20 10 10 0 1 0 0-20M4.6 5.4a11 11 0 0 1 0 13.2M19.4 5.4a11 11 0 0 0 0 13.2' },
  { id: 'volleyball', label: 'Vóleibol', category: 'deportes', keywords: ['voleibol', 'volley', 'playa', 'pelota'],
    d: 'M12 2a10 10 0 1 0 0 20 10 10 0 1 0 0-20M11 7a16 16 20 0 1 10.98 4.362M12 12a13 13 0 0 1-8.66 5M16.83 13.634a16 16 0 0 1-9.267 7.328M20.66 17A13 13 0 0 0 12 12a13 13 0 0 1 0-10M8.17 15.366a16 16 0 0 1-1.713-11.69' },
  { id: 'sport-shoe', label: 'Running', category: 'deportes', keywords: ['correr', 'carrera', 'maratón', 'atletismo', 'tenis'],
  ...
  { id: 'swim', label: 'Natación', category: 'deportes', keywords: ['alberca', 'piscina', 'nado', 'agua', 'aqua'],
    d: 'M2 12q2.5 2 5 0t5 0 5 0 5 0M2 19q2.5 2 5 0t5 0 5 0 5 0M2 5q2.5 2 5 0t5 0 5 0 5 0' },
  { id: 'person-standing', label: 'Clase', category: 'deportes', keywords: ['yoga', 'pilates', 'entrenamiento', 'funcional', 'zumba', 'baile'],
    d: 'M12 4a1 1 0 1 0 0 2 1 1 0 1 0 0-2M9 20l3-6 3 6M6 8l6 2 6-2M12 10v4' },
  { id: 'mountain', label: 'Escalada', category: 'deportes', keywords: ['montaña', 'senderismo', 'aventura', 'outdoor', 'cerro'],
